...
class ViewController: UIViewController {
    ...
    @IBAction func toPIProfileTapped(_ sender: Any) {
        // Get a reference to the storyboard
        print("Navigation Controller: \(String(describing: navigationController))")
            ...
            // Instantiate the ScanPageViewController by its Storyboard ID
            if let PIProfilePageVC = storyboard.instantiateViewController(withIdentifier: "PIProfilePageViewController") as? PIProfilePageViewController{
                print("PIProfilePageViewController instantiated successfully")
                // Navigate to PIProfilePageViewController
                navigationController?.pushViewController(PIProfilePageVC, animated: true)
            } else {
                print("Failed to instantiate PIProfilePageViewController")
            }
    }
